...
from src.narrative.sections.spec import default_spec  # si tu l’as déjà, sinon garde ton default_spec local
...
def build_section_blocks_from_manifest(run_root: Path, manifest: Dict[str, Any]) -> Dict[str, Any]:
    ...
    audit = {"blocks_written": sorted(out_map.keys()), "blocks_paths": out_map, "blocks_dir": "latex/blocks"}
